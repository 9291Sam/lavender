...
//     void
//     WorldManager::setVoxelObjectPosition(const VoxelObject& voxelObject, WorldPosition
//     newPosition)
//     {
...
//     {
//         util::assertFatal(
//             positions.size() < std::numeric_limits<u32>::max(), "Tried to poll too many
//             positions");
...
//                 this->chunk_render_manager.readShadow(*chunk,
//                 readbackInfo.chunk_local_positions);
...
//             {
//                 VoxelObjectTrackingData& thisData =
//                 this->voxel_object_tracking_data[voxelObjectId];
