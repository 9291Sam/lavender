...
//         void writeVoxel(std::vector<VoxelWrite>) const;

//         [[nodiscard]] VoxelWriteTransaction
//              writeVoxel(VoxelWriteOverlapBehavior, std::vector<VoxelWrite>) const;
...
//         void setCamera(game::Camera, gfx::profiler::TaskGenerator&) const;
