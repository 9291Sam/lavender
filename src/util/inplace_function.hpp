...
namespace stdext
{
    ...
    namespace inplace_function_detail
    {
        ...
        // libc++ and MSVC 64-bit seem to work fine right now, but why run the
        // risk?
        template<size_t Cap>
    ...
    public:
        ...
        inplace_function(T&& closure)
        {
            static_assert(
                ...
                "inplace_function cannot be constructed from non-copyable "
                "type");

            static_assert(
                sizeof(C) <= Capacity,
                "inplace_function cannot be constructed from object with this "
                "(large) size");
